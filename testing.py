...
if __name__ == "__main__":
    ...
    test_order.add_item(MenuItem("Burger", 10.00))
    test_order.add_item(MenuItem("Fries", 5.00))

    amount_paid = 20.00
    total = test_order.calculate_total()
    change = calculate_change(amount_paid, total)

    save_order(test_order, amount_paid, change, "orders.csv")

    print("Order saving test completed.")
    print(f"Total: ${total:.2f}")
    print(f"Amount paid: ${amount_paid:.2f}")
    print(f"Change: ${change:.2f}")
    print("Check test_orders.csv to see if the order was saved.")
